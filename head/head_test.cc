...
TEST_F(HeadTest, Test3) {
  ...
  auto f = [&]() {
    ...
    std::shared_ptr<tsdb::label::MatcherInterface> m1 = std::make_shared<tsdb::label::EqualMatcher>("label_1", "value_1");
    std::shared_ptr<tsdb::label::MatcherInterface> m2 = std::make_shared<tsdb::label::EqualMatcher>("label_0", "value_1");

    // 将 std::shared_ptr 存储到 vector 中
    std::vector<std::shared_ptr<tsdb::label::MatcherInterface>> matchers = {m1, m2};
...
TEST_F(HeadTest, Test5) {
  ...
  auto f = [&]() {
    ...
    std::vector<std::shared_ptr<::tsdb::label::MatcherInterface>> matchers = {
        std::make_shared<label::EqualMatcher>(m)};

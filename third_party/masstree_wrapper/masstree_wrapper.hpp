...
public:
  ...
  bool update_value(const char *key, std::size_t len_key, T *value, bool need_delete) {
    cursor_type lp(table_, key, len_key);
    bool found =
...
relaxed_atomic<mrcu_epoch_type> globalepoch (1);  // global epoch, updated regularly

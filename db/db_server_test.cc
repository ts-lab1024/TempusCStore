...
TEST_F(DBTest, TestProto1) {
  ...
  std::vector<std::shared_ptr<::tsdb::label::MatcherInterface>> matchers({(std::shared_ptr<::tsdb::label::MatcherInterface>(new ::tsdb::label::EqualMatcher("label_all", "label_all")))});

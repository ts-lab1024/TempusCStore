...
//      {new ::tsdb::label::EqualMatcher("label0", "label0_0")});
  std::vector<std::shared_ptr<::tsdb::label::MatcherInterface>> matchers(
      {std::shared_ptr<label::MatcherInterface>(new ::tsdb::label::EqualMatcher("label0", "label0_0"))});
...
//      {new ::tsdb::label::EqualMatcher("label_all", "label_all")});
  matchers =   std::vector<std::shared_ptr<::tsdb::label::MatcherInterface>> (
      {std::shared_ptr<label::MatcherInterface>(new ::tsdb::label::EqualMatcher("label_all", "label_all"))});

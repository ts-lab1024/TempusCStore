...
void InvertedIndex::async_select(const std::vector<std::shared_ptr<label::MatcherInterface>>* l,
                                 std::vector<std::vector<uint64_t>>* lists,
                                 void (*callback)(void* arg), void* arg) {
...
void InvertedIndex::_select_job(const std::vector<std::shared_ptr<label::MatcherInterface>>* l,
                                std::vector<std::vector<uint64_t>>* lists,
                                void (*callback)(void* arg), void* arg) {
  for (size_t i = 0; i < l->size(); i++) {
